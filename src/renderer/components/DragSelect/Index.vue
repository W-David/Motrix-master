<template>
  <div ref="container" style="position: relative; user-select: none; overflow-x: hidden; touch-action: none">
...
const collisionCheck = (node1, node2) =>
  node1.left < node2.left + node2.width && node1.left + node1.width > node2.left && node1.top < node2.top + node2.height && node1.top + node1.height > node2.top
...
export default {
  ...
  methods: {
    ...
    intersection(box) {
      ...
      if (JSON.stringify([...intersected]) !== JSON.stringify([...this.intersected])) {
