  ...
  <div class="mo-task-files" v-if="files">
    <div class="mo-table-wrapper">
      ...
      >
        ...
        <el-table-column :label="$t('task.file-name')" min-width="200" show-overflow-tooltip>
          <template slot-scope="scope">{{ scope.row.name }}</template>
        </el-table-column>
        <el-table-column :label="$t('task.file-extension')" width="80">
        ...
        <el-table-column :label="$t('task.file-size')" align="right" width="85">
...
import { bytesToSize, calcProgress, filterVideoFiles, filterAudioFiles, filterImageFiles, removeExtensionDot } from '@shared/utils'
