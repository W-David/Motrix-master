<template>
  <el-row class="task-progress-info">
    <el-col class="task-progress-info-left" :xs="12" :sm="7" :md="6" :lg="6">
    ...
    <el-col class="task-progress-info-right" v-if="isActive" :xs="12" :sm="17" :md="18" :lg="18">
...
<script>
import { bytesToSize, checkTaskIsBT, checkTaskIsSeeder, timeFormat, timeRemaining } from '@shared/utils'
